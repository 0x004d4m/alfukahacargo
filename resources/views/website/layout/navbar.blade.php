    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <form action="/order" method="GET">
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="booking_number" placeholder="{{__('order.orderSearch')}}"  required value="@if (Request::has('booking_number')){{Request::get('booking_number')}}@endif">
