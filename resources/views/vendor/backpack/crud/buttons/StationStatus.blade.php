...
<script>
    function blockEntry(id) {
        ...
        swal({
            ...
            text: "Are you sure you want to block this station?",
            icon: "warning",
            ...
            if (value) {
                $.ajax({
                    ...
                    success: function(result) {
                        new Noty({
                            type: "success",
                            text: "<strong>Station Blocked</strong><br>The station has been blocked successfully."
                        }).show();
                    ...
                    error: function(result) {
                        swal({
                        title: "NOT Blocked",
                        text: "There's been an error. Your station might not have been blocked.",
                        icon: "error",
                        timer: 4000,
                        buttons: false,
                        });
    ...
    function unblockEntry(id) {
        ...
        swal({
            title: "{!! trans('backpack::base.warning') !!}",
            text: "Are you sure you want to unblock this station?",
            icon: "warning",
            buttons: ["Cancel", "Confirm"],
            dangerMode: true,
        }).then((value) => {
            if (value) {
                $.ajax({
                    ...
                    success: function(result) {
                        new Noty({
                            type: "success",
                            text: "<strong>Station Unblocked</strong><br>The station has been unblocked successfully."
                        }).show();
                        crud.table.draw(false);
                        $('.modal').modal('hide');
                    },
                    error: function(result) {
                        swal({
                        title: "NOT Unblocked",
                        text: "There's been an error. Your station might not have been unblocked.",
                        icon: "error",
                        timer: 4000,
                        buttons: false,
                        });
